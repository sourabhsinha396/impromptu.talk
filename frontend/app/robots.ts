...
/* The streak page is one browser's own numbers, the referrals page is one
   ...
   with a 404, and a reset page is one link's hour. `/re-admin` is the
...
export default function robots(): MetadataRoute.Robots {
  return {
    rules: { userAgent: "*", allow: "/", disallow: ["/streak", "/administration", "/re-admin", "/pro/done", "/affiliate/referrals", "/reset"] },
