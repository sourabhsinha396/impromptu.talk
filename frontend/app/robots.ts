...
/* The streak page is one browser's own numbers, the referrals page is one
   ...
   with a 404, and a reset page is one link's hour. None of them is protection; this keeps a crawler from
   spending its budget on pages that say nothing to it. */
export default function robots(): MetadataRoute.Robots {
  return {
    rules: { userAgent: "*", allow: "/", disallow: ["/streak", "/administration", "/pro/done", "/affiliate/referrals", "/reset"] },
