...
/* The ten genres and five formats v0 seeds, the four operator tools, and
...
const FORMATS = ["surprise", "just-talk", "hot-take", "explain", "story"];
...
describe("icons", () => {
  it("covers every emoji v0 drew, each genre with its own silhouette", () => {
    ...
    expect(Object.keys(FORMAT_ICONS).sort()).toEqual([...FORMATS].sort());
